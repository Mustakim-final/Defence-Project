...
import com.example.finddoctor.Shop.CheckOutActivity;
...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.MyHolder>{
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        Glide.with(context).load(cartModel.getLeft_image()).into(holder.imageView);
        holder.textName.setText(cartModel.getLeft_name());
        holder.textPrice.setText(cartModel.getLeft_prize()+" টাকা");
    ...
    private void plusCartItem(MyHolder holder, CartModel cartModel) {
        ...
        cartModel.setTotalPrice(cartModel.getQuantity()*Float.parseFloat(cartModel.getLeft_prize()));
