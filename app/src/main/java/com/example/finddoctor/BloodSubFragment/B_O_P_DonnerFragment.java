...
public class B_O_P_DonnerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b__o__p__donner, container, false);
                    ...
                    reference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (blood.equals("O+")){
                                ...
                                Toast.makeText(getContext(),"আপনার রক্তের গ্রুপ O+ নয়",Toast.LENGTH_SHORT).show();
                            }
