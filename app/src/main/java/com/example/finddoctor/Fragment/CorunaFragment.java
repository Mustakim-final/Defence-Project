...
public class CorunaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_coruna, container, false);
        recyclerView=view.findViewById(R.id.corunaRecycler_ID);
