...
public class DermatologistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_dermatologist, container, false);

        recyclerView=view.findViewById(R.id.dermatologistRecycler_ID);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if (all_doctor.getType().equals("Dermatologist")&& all_doctor.getStatus().equals("yes")){
