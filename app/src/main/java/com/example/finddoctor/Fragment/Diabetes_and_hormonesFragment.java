...
public class Diabetes_and_hormonesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_diabetes_and_hormones, container, false);
        recyclerView=view.findViewById(R.id.diabetes_hormonesRecycler_ID);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if (all_doctor.getType().equals("Diabetes and hormones")&& all_doctor.getStatus().equals("yes")){
