...
public class Nose_ear_and_throat_specialistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_nose_ear_and_throat_specialist, container, false);

        recyclerView=view.findViewById(R.id.nose_ear_throatRecycler_ID);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if (all_doctor.getType().equals("Nose, ear and throat specialist")&& all_doctor.getStatus().equals("yes")){
