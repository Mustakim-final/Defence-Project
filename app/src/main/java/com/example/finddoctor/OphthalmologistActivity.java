...
public class OphthalmologistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent=getIntent();
        String type=intent.getStringExtra("Optha");
        ...
        recyclerView=findViewById(R.id.ophthalmologist_Recycler_ID);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if (all_doctor.getType().equals("Ophthalmologist")){
                        all_doctorList.add(all_doctor);
                    }
                }
                allAdapter=new AllAdapter(OphthalmologistActivity.this,all_doctorList);
